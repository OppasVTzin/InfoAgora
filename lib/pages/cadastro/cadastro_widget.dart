...
class _CadastroWidgetState extends State<CadastroWidget> {
  ...
  void initState() {
    ...
    _model.inputLoginTextController1 ??= TextEditingController();
    _model.inputLoginFocusNode1 ??= FocusNode();

    _model.inputLoginTextController2 ??= TextEditingController();
                      ...
                      child: Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.inputLoginTextController1,
                                    focusNode: _model.inputLoginFocusNode1,
                                    autofocus: false,
                                    enabled: true,
                                    obscureText: false,
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.inputLoginTextController2,
                                    focusNode: _model.inputLoginFocusNode2,
                                    autofocus: false,
                                    enabled: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                if ((_model.inputLoginTextController1.text ==
                                        'Dummy') &&
                                    (_model.inputLoginTextController2.text ==
                                        'password')) {
